...
} he_key_rapid_trigger_base_config_t;

typedef he_base_config_t he_config_t;
typedef he_base_config_t eeprom_he_config_t;
typedef he_base_config_t via_he_config_t;

typedef he_key_base_config_t he_key_config_t;
typedef he_key_base_config_t eeprom_he_key_config_t;
typedef he_key_base_config_t via_he_key_config_t;

typedef he_key_rapid_trigger_base_config_t he_key_rapid_trigger_config_t;
typedef he_key_rapid_trigger_base_config_t eeprom_he_key_rapid_trigger_config_t;
